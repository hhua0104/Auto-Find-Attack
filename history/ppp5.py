...
def print_attack(runtime,url):
    ...
    for j in range(0,len(all_data_tmp))[::-1]:
        ...
        print str(message2).replace('2018-07-02','7.2').replace('2018-07-03','7.3').replace('2018-07-04','7.4').replace('2018-07-05','7.5').replace('2018-07-06','7.6')
        #message1是普通播报
        #print message1
...
while True:
    ...
    #     url = 'https://172.16.1.245/api/v1/log?risk_level=high&action=allow&action=deny&count=100&offset='+str(offset*100)
    #     print url
    #     run_time =print_attack(run_time,url)
    #     print '. ',
